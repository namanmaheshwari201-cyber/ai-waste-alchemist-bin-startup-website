...
export class Backend implements backendInterface {
    ...
    async getAllLeads(): Promise<Array<ContactInfo>> {
        if (this.processError) {
            try {
    ...
    async submitFeedback(arg0: string, arg1: string, arg2: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async submitLead(arg0: string, arg1: string, arg2: string, arg3: string): Promise<boolean> {
        if (this.processError) {
            try {
